        ...
        <Container>
          <Grid container item xs={12} lg={7} justifyContent="center" mx="auto">
            <form className="mt-8 mb-2  max-w-screen-lg " onSubmit={handleSubmit}>
              <div className="flex  w-max gap-4">
                <div>
                  <Input name="hoten" onChange={(e) => onInputChange(e)}
                ...
                <div>
                  <Input color="blue" label="Ngày sinh" name="ngaysinh" onChange={(e) => onInputChange(e)} />
                </div>
                <div>
                  <Input color="blue" label="Đại chỉ" name="diachi" onChange={(e) => onInputChange(e)} />
                </div>
              </div>
              ...
              <div className="flex gap-4 mt-5">
                ...
                <div>
                  <Input type="email" color="blue" label="Email" name="email" onChange={(e) => onInputChange(e)} />
                </div>
              </div>
